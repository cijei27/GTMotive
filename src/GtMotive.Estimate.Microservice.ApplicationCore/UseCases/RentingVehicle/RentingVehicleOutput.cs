...
{
    /// <summary>
    /// The output for renting a vehicle.
    /// </summary>
    public class RentingVehicleOutput : IUseCaseOutput
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RentingVehicleOutput"/> class.
        /// </summary>
        ...
        public RentingVehicleOutput(Guid idRenting, Guid idVehicle, string dniCustomer, DateTime startRenting, DateTime finishRenting)
        {
            IdRenting = idRenting;
            IdVehicle = idVehicle;
